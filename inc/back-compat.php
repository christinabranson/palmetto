...
function foundation_upgrade_notice() {
	$message = sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'foundation' ), $GLOBALS['wp_version'] );
...
function foundation_customize() {
	wp_die( sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'foundation' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function foundation_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Sixteen requires at least WordPress version 4.4. You are running version %s. Please upgrade and try again.', 'foundation' ), $GLOBALS['wp_version'] ) );
	}
}
